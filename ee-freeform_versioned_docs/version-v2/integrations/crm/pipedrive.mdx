...
This documentation page assumes you have read over the [CRM Integration Overview page](../../integrations/crm/index.mdx). If you have not yet read it, please do so now. We also assume that you have a [Pipedrive](http://pipedrive.com) account already. This integration requires that you have _Freeform Pro_. If you currently have Freeform Lite, you can purchase an upgrade to Freeform Pro by visiting your account area.
