...
:::info
**If you're using a Freeform version <u>older</u> than 3.12**, please [click here to view the v3.11 documentation](./form-events-v3-11.mdx) that shows the old approach for usage of these events. All of the pre-3.12 events will continue to work with Freeform 3.12, but have been deprecated.
:::
