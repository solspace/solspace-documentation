...
You can achieve a dynamic template level email notification by using the [Dynamic Template Notifications](../../forms/email-notifications/#dynamic-template-notifications) feature. You would use this in place of regular [Admin Notifications](../../forms/email-notifications.mdx#admin), which are not flexible.
